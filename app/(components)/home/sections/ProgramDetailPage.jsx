        ...
        <main className="">
            <div className="">
                ...
                <div className="text-2xl gap-3.5  mb-4">
                    <span className="cursor-pointer text-lg text-[#C7044C]  font-inter font-semibold  hover:text-[#C7044C]">Programs</span> ›
                    <span className="cursor-pointer text-lg text-[#C7044C]  font-inter font-semibold  hover:text-[#C7044C]"> Courses</span> ›
                    <span className="cursor-pointer text-lg text-[#C7044C]  font-inter font-semibold  hover:text-[#C7044C]"> Universities</span> ›
                    <span className="cursor-pointer text-lg text-[#C7044C]  font-inter font-semibold hover:text-[#C7044C]"> Details</span>
                </div>
                ...
                <div className="bg-white p-5 rounded-md drop-shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-3 " >
                    <div>
                        <h1 className="text-xl md:text-2xl font-bold font-inter text-[#C7044C]">{program.title}</h1>
                        <p className="text-secondarytext text-sm flex items-center gap-2 mt-1">
                            Duration:<span className="inline-block "><Clock4 size={14} /></span> {program.duration}
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                    <div className="lg:col-span-1 flex flex-col gap-4">
                        <ProgramDetails title="Program Details">
                            ...
                            <p className="text-base text-secondarytext leading-relaxed">{program.requirements}</p>
                            <h3 className="font-semibold font-inter text-primaryheading md:text-lg mt-3 mb-1">Program Comments</h3>
                            <p className="text-xs text-gray-500 uppercase tracking-wide">{program.comments}</p>
                        </ProgramDetails>
