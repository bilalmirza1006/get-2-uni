                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-5 border bg-white rounded-[8px] drop-shadow-sm p-5 mb-5">
                        ...
                        <div className="flex gap-3 mt-3 md:mt-0">
                            <button className="border border-pink-500 text-pink-500 text-xs font-medium rounded-md px-4 py-2 hover:bg-pink-50 transition">
                                Shortlist
                            </button>
                            <button className="bg-pink-600 text-white text-xs font-medium rounded-md px-4 py-2 hover:bg-pink-700 transition">
                                Apply Now
                            </button>
                        </div>
                    </div>
