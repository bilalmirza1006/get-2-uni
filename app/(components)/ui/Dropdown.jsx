    ...
    return (
        ...
        >
            ...
            <div
                ...
                className={`
          flex justify-between items-center gap-1 w-full ${bgColor ? bgColor : 'bg-white'
        ...
        `}
            >
                <span className={`font-normal text-secondarytext ${defaultTextColor}`}>
                    {selected?.name || (typeof defaultValue === "string" ? defaultValue : defaultValue?.name) || "Select"}
                </span>
                <ChevronDown
          ...
          `}
            ...
            bg-white border border-[#E4E4E7] rounded-md
            shadow-lg
